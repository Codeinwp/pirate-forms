...
?>
	<input type="checkbox" class="<?php echo apply_filters( "pirateform_field_classes_{$name}", '', $name, $args['type'] );?>" <?php echo $extra; ?> <?php echo $this->get_common( $args ); ?> value="<?php esc_attr_e( $key );?>">&nbsp;<?php esc_attr_e( $val ); ?>
<?php
	}
?>
</div>
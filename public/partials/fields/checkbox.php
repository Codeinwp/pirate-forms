...
?>
<input type="checkbox" class="<?php echo apply_filters( "pirateform_field_classes_{$name}", '', $name, $args['type'] ); ?>" <?php echo $extra; ?> <?php echo $this->get_common( $args ); ?> value="<?php echo esc_attr( $key ); ?>">&nbsp;<?php echo esc_attr( $val ); ?>
<?php
}
?>
</div>

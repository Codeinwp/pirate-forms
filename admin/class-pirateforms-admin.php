...
class PirateForms_Admin {
	...
	public function enqueue_styles_and_scripts() {
		...
		if ( ! empty( $pagenow ) && ( $pagenow == 'options-general.php' || $pagenow == 'admin.php' )
			...
			wp_enqueue_style( 'pirateforms_admin_styles', PIRATEFORMS_URL__ . 'admin/css/wp-admin.css' );
			wp_enqueue_script( 'pirateforms_scripts_admin', PIRATEFORMS_URL__ . 'admin/js/scripts-admin.js', array( 'jquery' ) );
	...
	public function pirate_forms_add_to_admin() {
		add_menu_page( PIRATEFORMS_NAME__, PIRATEFORMS_NAME__, 'manage_options', 'pirateforms-admin', array( $this, 'pirate_forms_admin' ), 'dashicons-feedback' );
		add_submenu_page( 'pirateforms-admin', PIRATEFORMS_NAME__, __( 'Settings', 'pirate-forms' ), 'manage_options', 'pirateforms-admin', array( $this, 'pirate_forms_admin' ) );
	}

...
class PirateForms_Admin {
	...
	function pirate_forms_plugin_options() {
		...
		return apply_filters( 'pirate_forms_admin_controls', array(
			'pirate_options pirate_dashicons' => array(
				'heading'   => __( 'Form processing options', 'pirate-forms' ),
				'controls'  => apply_filters( 'pirate_forms_admin_controls_for_options', array(
					array(
			...
			'pirate_fields pirate_dashicons'  => array(
				...
				'controls'  => apply_filters( 'pirate_forms_admin_controls_for_fields', array(
					/* Name */
					array(
			...
			'pirate_labels' => array(
				...
				'controls'  => apply_filters( 'pirate_forms_admin_controls_for_field_labels', array(
					array(
			...
			'pirate_alerts pirate_dashicons'  => array(
				...
				'controls'  => apply_filters( 'pirate_forms_admin_controls_for_alerts', array(
					array(
			...
			'pirate_smtp pirate_dashicons'  => array(
				...
				'controls'  => apply_filters( 'pirate_forms_admin_controls_for_smtp', array(
					array(
